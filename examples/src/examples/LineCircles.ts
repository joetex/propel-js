...
export function lineCirclesInit(): physics.World {
    ...
    const ramp1 = physics.createLine(world, { x: 80, y: 360 }, { x: 240, y: 250 }, 0, friction, restitution);
    const ramp2 = physics.createLine(world, { x: 280, y: 260 }, { x: 430, y: 340 }, 0, friction, restitution);
